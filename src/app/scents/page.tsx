...
export default function ScentsPage() {
  ...
  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setPage(1)
    fetchScents({ search: e.target.value, page: 1, limit })
  }

  const handlePageChange = (newPage: number) => {
    setPage(newPage)
    fetchScents({ search: searchQuery, page: newPage, limit })
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Mùi Hương</h1>
          <p className="text-gray-600">Khám phá bộ sưu tập mùi hương chất lượng cao</p>
        </div>
